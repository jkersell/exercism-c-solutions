...
cases = [ Case { description = "Methionine RNA sequence"
        ...
        , Case { description = "Translation stops if there is an invalid nucleotide"
               , input       = "UGGUGZUAU"
               , expected    = Just ["Tryptophan"]
               }
        , Case { description = "Translation ignores partial codons"
               , input       = "UGGUGUUA"
               , expected    = Just ["Tryptophan","Cysteine"]
               }
        , Case { description = "Translation stops if there is an unknown codon"
               , input       = "UGGUGAUUU"
               , expected    = Just ["Tryptophan"]
               }
        ]
